...
\begin{figure}
\centering \includegraphics[scale=0.6]{problem.pdf}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{flashlog_page.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[scale=0.6]{network_packet.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{nvm_log.pdf}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{batching.pdf}
  \caption{Batching}
  \label{fig:batching}
\end{figure}
...
%\begin{figure}
%  \centering
%  \includegraphics[scale=0.35]{race.pdf}
...
\begin{figure}
\includegraphics[scale=0.6]{network_opts.pdf}
...
\begin{figure}
  \includegraphics[scale=0.6]{replicas.pdf}
...
\begin{figure}
  \includegraphics[scale=0.6]{flashlog.pdf}
...
\begin{figure}
  \includegraphics[scale=0.6]{flashlog_512.pdf}
  \caption{Second level log - 512 bytes payload}
  \label{fig:flashlog_512}
\end{figure}

\begin{figure}
  \includegraphics[scale=0.6]{multi.pdf}
  \caption{Ganged Operations}
  \label{fig:ganged}
\end{figure}

\begin{figure}
  \includegraphics[scale=0.6]{kv_baseline.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{rocksdb.pdf}
    \caption{Rocksdb - small updates}
    \label{fig:rocksdb}
  \end{figure}
   
  \begin{figure}
    \includegraphics[scale=0.6]{rocksdb_256.pdf}
    \caption{Rocksdb - large updates}
    \label{fig:rocksdb_256}
  \end{figure}
   
  \begin{figure}
    \includegraphics[scale=0.6]{rocksdb_multi.pdf}
...
\begin{figure}
\includegraphics[scale=0.6]{fb.pdf}
\caption{Rocksdb - read heavy}
\label{fig:fb}
\end{figure}
\begin{figure}
  \includegraphics[scale=0.6]{fb2.pdf}
  \caption{Rocksdb - write heavy}
  \label{fig:fb2}
\end{figure}
\begin{figure}
  \includegraphics[scale=0.6]{failover.pdf}
