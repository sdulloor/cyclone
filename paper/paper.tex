...
data. For small updates, the synchronous write latency dominates the time for
IO.  Cyclone avoids this by making use of directly attached persistent memory on
the server. This can be in the form of NVDIMMs (DIMMs with an added
