...
executing any PUT or DELETE request, Cyclone appends it to a durable log and replicates
...
requests to deal with failure. We do not provide exactly once semantics as we
...
exactly once semantics to Cyclone's client-server protocol itself to serve as a
